...
const Footer = () => {
  return (
    <div>
      <footer className="footer sm:footer-horizontal bg-black text-white p-16 rounded-t-2xl">
        <nav>
          ...
          <p className="text-accent">
            “Every dream deserves a chance to grow. <br /> We're here to guide
            you toward the future you imagine.”
          </p>
        </nav>
        <nav>
